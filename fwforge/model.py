...
class Address:
    name: str
    type: str = "subnet"  # host | subnet | range | fqdn | wildcard | geography
    value: str = ""  # subnet: "10.0.0.0/24"; range: "10.0.0.1-10.0.0.9"; fqdn: "x.com"; wildcard: "ip/mask"; geography: "RU"
    comment: str | None = None
    source: SourceRef | None = None
